...
#define RESULT_TABLE_IDX_COLUMN 5
#define ERROR_TYPE_COLUMN 6
#define ISSUE_ID_COLUMN 7
#define TEST_RESULT_ID_COLUMN 8
#define OBJECT_TESTED_COLUMN 9
...
private slots:
    ...
    void userInputDialogUIDC(QListWidgetItem*);
    void createTest();
    void removeTests();
    void createSuite();
    void removeSuites();
